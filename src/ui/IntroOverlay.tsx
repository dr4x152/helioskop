    ...
    >
      ...
      >
        ...
        <p className="mt-3 text-sm leading-relaxed text-pretty text-muted">
          Schematyczny model Keplera: Słońce, osiem planet, Pluton, księżyce i komety. Dalej —
          kosmos lokalny (M31, M33, Sgr A*) oraz scenariusz ewolucji Słońca. Skala odległości jest
          lekko ściśnięta; treści spekulatywne są podpisane.
        </p>
        <ul className="mt-4 space-y-1.5 font-mono text-[12px] text-muted">
          <li>Przeciągnij, aby obracać · R = reset kamery</li>
          <li>Komety, Ewolucja Słońca, Kosmos lokalny — w HUD</li>
          <li>Poważne wydarzenia pauzują czas (modal)</li>
